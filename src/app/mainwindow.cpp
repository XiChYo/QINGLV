...
#include <QDir>
#include "legacy/updatemanager.h"
#include "pipeline/boardcontrol.h"
...
void MainWindow::on_languageButton_clicked()
{
    ...
    if (m_currentLanguage == "chinese") // 当前是中文，更改成英文版本
    {
        ...
        m_translator.load(":/new/prefix/guangxuan_zh_CN.qm");
    ...
    else // 当前是英文，更改成中文版本
    {
        ...
        m_translator.load(":/new/prefix/guangxuan_zh_EN.qm");
        qApp->installTranslator(&m_translator);
        ui->retranslateUi(this);
