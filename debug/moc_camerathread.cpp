...
QT_MOC_LITERAL(1, 13, 13), // "frameReadySig"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "img"
QT_MOC_LITERAL(4, 32, 11), // "errorMegSig"
QT_MOC_LITERAL(5, 44, 6) // "errMeg"

    },
    "camerathread\0frameReadySig\0\0img\0"
    "errorMegSig\0errMeg"
};
...
void camerathread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->frameReadySig((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        case 1: _t->errorMegSig((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camerathread::frameReadySig)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camerathread::errorMegSig)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void camerathread::frameReadySig(const QImage & _t1)
{
...
// SIGNAL 1
void camerathread::errorMegSig(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
